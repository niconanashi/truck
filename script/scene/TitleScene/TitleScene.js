...
var TitleScene = /** @class */ (function (_super) {
    ...
    function TitleScene(param) {
        ...
        _this.onLoad.add(function () {
            ...
            if (_this.stateManager.sessionParameter.config.debug)
                _this.createDebugButton();
        });
        return _this;
    }
    ...
    TitleScene.prototype.createDebugButton = function () {
        ...
        join10Button.onPointUp.add(function () {
            ...
            join10Button.invalidate();
            if (!_this.stateManager.applicantList)
                return; // 参加者受付を開始していない
            for (var i = 0; i < 10; i++) {
                var name_1 = "";
