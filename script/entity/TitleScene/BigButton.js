 ...
 * 準備画面仕様の大ボタンq
 */
var BigButton = /** @class */ (function (_super) {
    __extends(BigButton, _super);
    function BigButton(params) {
        var _this = this;
        var width = 720; // レイアウト指示書で定義
        var height = 120; // レイアウト指示書で定義
        _this = _super.call(this, __assign(__assign({}, params), { width: width, height: height, backgroundEffector: new g.NinePatchSurfaceEffector(g.game, {
                top: 55,
                bottom: 55,
                left: 64,
                right: 64
            }), backgroundImage: params.scene.assets.btn_frame_join })) || this;
