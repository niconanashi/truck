 ...
 */
var WaitingText = /** @class */ (function (_super) {
    __extends(WaitingText, _super);
    function WaitingText(params) {
        var _this = _super.call(this, __assign(__assign({}, params), { width: g.game.width, height: 71 })) || this;
        ...
        var duration = 500;
        _this.timeline.create(_this, { loop: true })
            .wait(duration)
            .call(function () {
            textLabel.text = "集計中・";
