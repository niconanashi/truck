 ...
 * あそびかた説明
 */
var HowtoText = /** @class */ (function (_super) {
    __extends(HowtoText, _super);
    function HowtoText(params) {
        var _this = this;
        var width = 1030; // 手調整 (レイアウト指示+30)
        var height = 340; // 手調整 (レイアウト指示+60)
        _this = _super.call(this, __assign(__assign({}, params), { width: width, height: height, anchorX: 0.5, anchorY: 0, x: g.game.width / 2, backgroundEffector: new g.NinePatchSurfaceEffector(g.game, 20), backgroundImage: params.scene.assets.frame_howto })) || this;
