 ...
 */
var RecruitmentCountDown = /** @class */ (function (_super) {
    __extends(RecruitmentCountDown, _super);
    function RecruitmentCountDown(params) {
        var _this = this;
        var width = 486;
        var height = 64;
        _this = _super.call(this, __assign(__assign({}, params), { width: width, height: height, x: g.game.width / 2, anchorX: 0.5, anchorY: 0 })) || this;
    ...
    RecruitmentCountDown.prototype.setTime = function (value) {
        ...
        this.digits.forEach(function (e) { return e.invalidate(); });
    };
