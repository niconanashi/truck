...
var RankingLabel = /** @class */ (function (_super) {
    ...
    RankingLabel.prototype.scroll = function (speedType) {
        var _this = this;
        if (speedType === void 0) { speedType = ScrollSpeedType.Normal; }
        switch (speedType) {
        ...
        var createScrollTween = function () {
            var moveDistance = 53 * _this._rankingPlayerIdList.length + 137 - 50;
            _this._scrollTween = _this.scene.timeline
                .create(_this._root, { loop: true })
                .wait(200 * _this._scrollTimeUnit)
                .moveTo(0, -moveDistance, (moveDistance + _this._root.y) * _this._scrollTimeUnit)
                .call(function () {
                _this._root.y = 470;
