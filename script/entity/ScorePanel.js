...
var ScorePanel = /** @class */ (function (_super) {
    ...
    ScorePanel.prototype.swell = function () {
        var _this = this;
        if (this.scoreUpTween != null)
            return;
        this.scoreUpTween = this.timeline.create(this)
            .to({ scaleY: 0.9 }, 200)
            .to({ scaleY: 1.25 }, 400, akashic_timeline_1.Easing.easeOutCubic)
            .to({ scaleY: 1.0 }, 200, akashic_timeline_1.Easing.easeInExpo)
            .call(function () {
