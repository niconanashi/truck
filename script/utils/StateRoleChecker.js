...
function checkStateRole(playerState, roleType) {
    switch (roleType) {
        case StateRoleType.CanCollideType:
            return (playerState !== StateManager_1.PlayerState.ghost &&
                playerState !== StateManager_1.PlayerState.invincible &&
                playerState !== StateManager_1.PlayerState.staging);
        ...
        case StateRoleType.CanOperateType:
            return (playerState !== StateManager_1.PlayerState.staging &&
                playerState !== StateManager_1.PlayerState.dead);
        ...
        case StateRoleType.IsAudienceType:
            return (playerState === StateManager_1.PlayerState.dead ||
                playerState === StateManager_1.PlayerState.staging);
        default:
            // never
            return false;
